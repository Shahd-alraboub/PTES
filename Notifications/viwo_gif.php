...
$userID = $_SESSION['userID'] ?? 0; // التأكد من تسجيل دخول المستخدم

// جلب الهدايا
$giftsResult = $gift->getGiftsNotReceived($userID); // مباشرة الحصول على الهدايا
$receivedGifts = !empty($giftsResult) ? $giftsResult : []; // التأكد من أن هناك هدايا
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($updateStatus) {
        ...
        header("Location:../booking/ticket_viwe.php");
        exit();
    } else {
